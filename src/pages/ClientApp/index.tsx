            ...
            {!isOutOfStock ? (
              <div className="grid w-full grid-cols-[42px_1fr] gap-2">
                <button
                  ...
                  className="flex min-w-0 items-center justify-center rounded-xl border border-slate-200 bg-white px-2 py-2.5 text-slate-700 transition-colors hover:border-[#ff4c00]/60 hover:text-[#ff4c00]"
